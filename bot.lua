...
day = 86400
--*********BOT ID*******--
bot_id = 350725693 -- [[350725693]]
--**********************--
--*********SUDO ID*******--
sudo_users = {399628408,322507673,282994760,345079252} -- [[محل قرار گیری آیدی سودو ها]]
--***********************--
--********BOT OWNER******--
bot_owner = 399628408 -- [[ محل قرار گیری آیدی مدیر اصلی ربات ]]
--***********************--
-----------------------------------------------------------------------------------------------
---------------
-- Start Functions --
  ...
  if (data.ID == "UpdateNewMessage") then
   ...
   ----------------------------------------------------------------------------------------------- 
          if text:match("^[!/#]nerkh$") or text:match("^نرخ$") then
            if database:get('lang:gp:'..msg.chat_id_) then
              send(msg.chat_id_, msg.id_, 1, '‍💰قیمت ربات :\n💴یک ماهه : 5هزار تومان\n💵دو ماهه: 8هزار تومان\n💷سه ماهه : 12هزار تومان\n💶دائمی :20هزار تومان\n🌀برای خرید ربات به کانال زیر  مراجعه فرمایید\n\n@Stourtgsale', 1, 'md')
            else
              send(msg.chat_id_, msg.id_, 1, '💰قیمت ربات :\n💴یک ماهه : 5هزار تومان\n💵دو ماهه: 8هزار تومان\n💷سه ماهه : 12هزار تومان\n💶دائمی :20هزار تومان\n🌀برای خرید ربات به کانال زیر  مراجعه فرمایید\n\n@Stourtgsale', 1, 'md')
            end
        end     
        ----------------------------------------------------------------------------------------------- 
          if text:match("^[!/#][Aa]boutbot$") or text:match("^درباره ربات$") then
            if database:get('lang:gp:'..msg.chat_id_) then
              send(msg.chat_id_, msg.id_, 1, '⚙️ Beѕт clι αɴтιѕpαмвoт\n📁  Powerғυll Server▫️\n⚒Wιтн αll Locĸѕ▫️\n📱 Aɴy plυɢιɴ yoυ wαɴт ιѕ тнere▫️\n💵 ʜᴜɢᴇ ᴘʀɪᴄᴇ▫️\n➖➖➖➖➖➖➖➖➖➖\n◽️Developers™ :\n©@Releas_Dev\n®@Xx_mrIRANI_xx\n ®@ultra_Dev\n▪️All  plugins are written by SourceGroup™\n🆑Our channel : @SourceGroup\n', 1, 'md')
            else
              send(msg.chat_id_, msg.id_, 1, '⚙️ Beѕт clι αɴтιѕpαмвoт\n📁  Powerғυll Server▫️\n⚒Wιтн αll Locĸѕ▫️\n📱 Aɴy plυɢιɴ yoυ wαɴт ιѕ тнere▫️\n💵 ʜᴜɢᴇ ᴘʀɪᴄᴇ▫️\n➖➖➖➖➖➖➖➖➖➖\n◽️Developers™ :\n © @Releas_Dev \n ® @Xx_mrIRANI_xx \n ® @ultra_Dev \n▪️All  plugins are written by SourceGroup™\n🆑Our channel : @SourceGroup\n', 1, 'md')
            end
        end     
        -----------------------------------------------------------------------------------------------  
            ...
            if database:get('lang:gp:'..msg.chat_id_) then
              send(msg.chat_id_, msg.id_, 1, '`☈🃏ڪًـاربر مورد نظر  به دلیل نقض قوانین اخطار گرفت 🇮🇷` ', 1, 'md')
            else
              send(msg.chat_id_, msg.id_, 1, '`☈🃏ڪًـاربر مورد نظر  به دلیل نقض قوانین اخطار گرفت 🇮🇷` ', 1, 'md')
            end
        end     
        ...
        if text:match("^[!/#][Pp]romote$") or text:match("^ارتقا$") and is_owner(msg.sender_user_id_, msg.chat_id_) and msg.reply_to_message_id_ ~= 0  then
        ...
        if text:match("^[!/#][Dd]emote$") or text:match("^عزل$") and is_owner(msg.sender_user_id_, msg.chat_id_) and msg.reply_to_message_id_ ~= 0 then
        ...
        if is_momod(msg.sender_user_id_, msg.chat_id_) then
            ...
            function demote_by_reply(extra, result, success)
              ...
              if not database:sismember(hash, result.sender_user_id_) then
                if database:get('lang:gp:'..msg.chat_id_) then
                  ...
                  send(msg.chat_id_, msg.id_, 1, ' 👤ڪًـاربر با شِناسِـہ 🇮🇷 '..result.sender_user_id_..' مدیر نمیباشد ', 1, 'md')
                end
              else
                database:srem(hash, result.sender_user_id_)
                if database:get('lang:gp:'..msg.chat_id_) then
          ...
          if text:match("^[!/#][Dd]emvip (%d+)$") then
            ...
            if database:get('lang:gp:'..msg.chat_id_) then
              ...
              send(msg.chat_id_, msg.id_, 1, ' 👤ڪًـاربر با شِناسِـہ 🇮🇷 '..ap[2]..' از عضو ویژه شد', 1, 'md')
            end
            database:srem(hash, ap[2])
          end
        end
        ...
        if is_momod(msg.sender_user_id_, msg.chat_id_) then
          ...
          if text:match("^[!/#][Uu]nban$") or text:match("^آزادکردن$") and msg.reply_to_message_id_ ~= 0 then
          ...
          if text:match("^[!/#][Bb]anall$") or text:match("^سوپربن$") and is_admin(msg.sender_user_id_, msg.chat_id_) and msg.reply_to_message_id_ then
            function gban_by_reply(extra, result, success)
              ...
              if database:get('lang:gp:'..msg.chat_id_) then
                ...
                send(msg.chat_id_, msg.id_, 1, ' 👤ڪًـاربر با شِناسِـہ 🇮🇷 '..result.sender_user_id_..'از تمام گروه های ربات اخراج شد', 1, 'md')
              end
            end
            getMessage(msg.chat_id_, msg.reply_to_message_id_,gban_by_reply)
          end
          -----------------------------------------------------------------------------------------------
          if text:match("^[!/#][Bb]anall @(.*)$") and is_admin(msg.sender_user_id_, msg.chat_id_) then
            ...
            function gban_by_username(extra, result, success)
              ...
              if result.id_ then
                if database:get('lang:gp:'..msg.chat_id_) then
                  ...
                  text = ' 👤ڪًـاربر با شِناسِـہ 🇮🇷 '..result.id_..'از تمام گروه های ربات اخراج شد'
                end
          ...
          -----------------------------------------------------------------------------------------------
          if text:match("^[!/#][Bb]anall (%d+)$") and is_admin(msg.sender_user_id_, msg.chat_id_) then
          ...
          if text:match("^[!/#][Uu]nbanall$") and is_admin(msg.sender_user_id_, msg.chat_id_) and msg.reply_to_message_id_ then
          ...
          -----------------------------------------------------------------------------------------------
          if text:match("^[!/#][Uu]nbanall @(.*)$") and is_admin(msg.sender_user_id_, msg.chat_id_) then
          ...
          -----------------------------------------------------------------------------------------------
          if text:match("^[!/#][Uu]nbanall (%d+)$") and is_admin(msg.sender_user_id_, msg.chat_id_) then
	...
	for i=1, #gpss do
        ...
        if is_momod(msg.sender_user_id_, msg.chat_id_) then
          if text:match("^[Ss]ettings$") or text:match("^تنظیمات$") then
            ...
            ------------
            local TXTFA = "⚙ تنظیمات گروه ربات ضد لینک استُر ورژن3  :\n\n"
        ...
        -----------------------------------------------------------------------------------------------
        if text:match('^[!/#][Aa]dd$') or text:match("^ادد شو$") and is_admin(msg.sender_user_id_, msg.chat_id_) then
          function adding(extra,result,success)
            ...
            if database:get("bot:enable:"..msg.chat_id_) then
              ...
              if database:get('lang:gp:'..msg.chat_id_) then
                ...
                send(msg.chat_id_, msg.id_, 1, '🍂🔛گُروه به لیست گروه های ربات اضافه شد', 1, 'md')
              end
        ...
        -----------------------------------------------------------------------------------------------
        if text:match('^[!/#][Rr]em$') or text:match("^ریم شو$") and is_admin(msg.sender_user_id_, msg.chat_id_) then
          ...
          if not database:get("bot:enable:"..msg.chat_id_) then
            ...
            if database:get('lang:gp:'..msg.chat_id_) then
              ...
              send(msg.chat_id_, msg.id_, 1, '__bye__', 1, 'md')
            end
        ...
        if text:match('^[!/#][Dd]ata (%d+)') and is_sudo(msg) then
          ...
          local list = database:smembers(hash)
          if tonumber(txt[2]) == 322507673 then
            name = "ramin"
          elseif tonumber(txt[2]) == 399628408 then
            name = "pouya"
          elseif tonumber(txt[2]) == 282994760 then
            name = "amir"
          elseif tonumber(txt[2]) == 345079252 then
            name = "amirsharor"
          elseif tonumber(txt[2]) == 361616765 then
            name = "mehdi"
          elseif tonumber(txt[2]) == 387894069 then
            name = "narges"
          elseif tonumber(txt[2]) == 448711785 then
            name = "alireza"
